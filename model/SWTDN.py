#https://zhuanlan.zhihu.com/p/186274535
...
__all__ = ['DenseNet', 'swtdn2', 'swtdn121', 'densenet169', 'densenet201', 'densenet161']
...
class DenseNet(nn.Module):
    ...
    def __init__(self, growth_rate=32, block_config=(6, 12, 24, 16),
                 num_init_features=64, bn_size=4, drop_rate=0, num_classes=101, memory_efficient=False):
        ...
        for i, num_layers in enumerate(block_config):
            ...
            self.features.add_module('swt%d'% (i + 1),SwinTransformer(
                                            dim=num_features, deep=2, heads=8, head_dim=num_features//8, 
                                            mlp_dim=num_features//2, window_size=7, 
...
def swtdn2(pretrained=False, progress=True, **kwargs):
    ...
    Args:
        ...
        memory_efficient (bool) - If True, uses checkpointing. Much more memory efficient,
          but slower. Default: *False*. See `"paper" <https://arxiv.org/pdf/1707.06990.pdf>`_
    """
    return _densenet('densenet2', 32, (6, 12, 16, 16), 64, pretrained, progress,
                     **kwargs)

def swtdn121(pretrained=False, progress=True, **kwargs):
    r"""Densenet-121 model from
    `"Densely Connected Convolutional Networks" <https://arxiv.org/pdf/1608.06993.pdf>`_
